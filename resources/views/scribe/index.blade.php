    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="analytics">
                    <a href="#analytics">Analytics</a>
                                    ...
                                    <ul id="tocify-subheader-analytics" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="analytics-GETapi-analytics">
                                <a href="#analytics-GETapi-analytics">GET api/analytics</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="currencies">
                    <a href="#currencies">Currencies</a>
                                    ...
                                    <ul id="tocify-subheader-currencies" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="currencies-GETapi-currencies">
                                <a href="#currencies-GETapi-currencies">GET api/currencies</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="dashboard">
                    <a href="#dashboard">Dashboard</a>
                                ...
                                <a href="#dashboard-GETapi-dashboard">GET api/dashboard</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="exchange-rates">
                    <a href="#exchange-rates">Exchange Rates</a>
                                ...
                                <a href="#exchange-rates-GETapi-exchange-rates">GET api/exchange-rates</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="exchange-rates-POSTapi-exchange-rates">
                                <a href="#exchange-rates-POSTapi-exchange-rates">POST api/exchange-rates</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="exchange-rates-PUTapi-exchange-rates--id-">
                                <a href="#exchange-rates-PUTapi-exchange-rates--id-">PUT api/exchange-rates/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="exchange-rates-DELETEapi-exchange-rates--id-">
                                <a href="#exchange-rates-DELETEapi-exchange-rates--id-">DELETE api/exchange-rates/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="profile">
                    <a href="#profile">Profile</a>
                                ...
                                <a href="#profile-GETapi-me">GET api/me</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="profile-PATCHapi-me-preferences">
                                <a href="#profile-PATCHapi-me-preferences">PATCH api/me/preferences</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
        ...
        <h1 id="analytics">Analytics</h1>
                                ...
                                <h2 id="analytics-GETapi-analytics">GET api/analytics</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-analytics"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The category name. Must be unique per user. Must not be greater than 100 characters. Example: <code>Freelance</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Optional color token or hex code for the category. Must not be greater than 20 characters. Example: <code>#0f766e</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Optional icon identifier used by the mobile client. Must not be greater than 50 characters. Example: <code>briefcase</code></p>
        </div>
        </form>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated category name. Must remain unique per user. Must not be greater than 100 characters. Example: <code>Household Bills</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>color</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated category color. Must not be greater than 20 characters. Example: <code>#dc2626</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>icon</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated icon identifier. Must not be greater than 50 characters. Example: <code>receipt</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Whether the category should be archived. Example: <code>false</code></p>
        </div>
        </form>
...
<p>The ID of the category. Example: <code>1</code></p>
                ...
                <h1 id="currencies">Currencies</h1>
                                ...
                                <h2 id="currencies-GETapi-currencies">GET api/currencies</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="dashboard">Dashboard</h1>
                                ...
                                <h2 id="dashboard-GETapi-dashboard">GET api/dashboard</h2>
...
<p>New password confirmation. Example: <code>Google_2New</code></p>
                ...
                <h1 id="exchange-rates">Exchange Rates</h1>
                                ...
                                <h2 id="exchange-rates-GETapi-exchange-rates">GET api/exchange-rates</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-exchange-rates"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="exchange-rates-POSTapi-exchange-rates">POST api/exchange-rates</h2>
...
<span id="example-requests-POSTapi-exchange-rates">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    \"to_currency_id\": 2,
    \"rate\": 89500.25,
    \"effective_at\": \"2026-05-10 12:00:00\"
}"
</code></pre></div>
...
<span id="example-responses-POSTapi-exchange-rates">
</span>
<span id="execution-results-POSTapi-exchange-rates" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-exchange-rates"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-exchange-rates"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-exchange-rates" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-exchange-rates">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-exchange-rates" data-method="POST"
      data-path="api/exchange-rates"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-exchange-rates', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-exchange-rates"
                    onclick="tryItOut('POSTapi-exchange-rates');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-exchange-rates"
                    onclick="cancelTryOut('POSTapi-exchange-rates');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-exchange-rates"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-exchange-rates"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-exchange-rates"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-exchange-rates"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>from_currency_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="from_currency_id"                data-endpoint="POSTapi-exchange-rates"
               value="1"
               data-component="body">
    <br>
<p>The source currency ID. The value and <code>to_currency_id</code> must be different. The <code>id</code> of an existing record in the currencies table. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>to_currency_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="to_currency_id"                data-endpoint="POSTapi-exchange-rates"
               value="2"
               data-component="body">
    <br>
<p>The target currency ID. The value and <code>from_currency_id</code> must be different. The <code>id</code> of an existing record in the currencies table. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rate"                data-endpoint="POSTapi-exchange-rates"
               value="89500.25"
               data-component="body">
    <br>
<p>Conversion rate from the source currency into the target currency. Example: <code>89500.25</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>effective_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="effective_at"                data-endpoint="POSTapi-exchange-rates"
               value="2026-05-10 12:00:00"
               data-component="body">
    <br>
<p>Timestamp from which this rate becomes valid. Defaults to now when omitted. Must be a valid date. Example: <code>2026-05-10 12:00:00</code></p>
        </div>
        </form>

                    <h2 id="exchange-rates-PUTapi-exchange-rates--id-">PUT api/exchange-rates/{id}</h2>
...
<span id="example-requests-PUTapi-exchange-rates--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/exchange-rates/16" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    ...
    \"to_currency_id\": 2,
    \"rate\": 90000,
    \"effective_at\": \"2026-05-11 09:30:00\"
}"
</code></pre></div>
...
<span id="example-responses-PUTapi-exchange-rates--id-">
</span>
<span id="execution-results-PUTapi-exchange-rates--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-exchange-rates--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-exchange-rates--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-exchange-rates--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-exchange-rates--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-exchange-rates--id-" data-method="PUT"
      data-path="api/exchange-rates/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-exchange-rates--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-exchange-rates--id-"
                    onclick="tryItOut('PUTapi-exchange-rates--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-exchange-rates--id-"
                    onclick="cancelTryOut('PUTapi-exchange-rates--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-exchange-rates--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/exchange-rates/{id}</code></b>
        </p>
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/exchange-rates/{id}</code></b>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-exchange-rates--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-exchange-rates--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-exchange-rates--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-exchange-rates--id-"
               value="16"
               data-component="url">
    <br>
<p>The ID of the exchange rate. Example: <code>16</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>from_currency_id</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="from_currency_id"                data-endpoint="PUTapi-exchange-rates--id-"
               value="1"
               data-component="body">
    <br>
<p>Updated source currency ID. The value and <code>to_currency_id</code> must be different. The <code>id</code> of an existing record in the currencies table. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>to_currency_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="to_currency_id"                data-endpoint="PUTapi-exchange-rates--id-"
               value="2"
               data-component="body">
    <br>
<p>Updated target currency ID. The value and <code>from_currency_id</code> must be different. The <code>id</code> of an existing record in the currencies table. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>rate</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rate"                data-endpoint="PUTapi-exchange-rates--id-"
               value="90000"
               data-component="body">
    <br>
<p>Updated conversion rate. Example: <code>90000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>effective_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="effective_at"                data-endpoint="PUTapi-exchange-rates--id-"
               value="2026-05-11 09:30:00"
               data-component="body">
    <br>
<p>Updated effective timestamp for the rate. Must be a valid date. Example: <code>2026-05-11 09:30:00</code></p>
        </div>
        </form>

                    <h2 id="exchange-rates-DELETEapi-exchange-rates--id-">DELETE api/exchange-rates/{id}</h2>
...
<span id="example-requests-DELETEapi-exchange-rates--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-exchange-rates--id-">
</span>
<span id="execution-results-DELETEapi-exchange-rates--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-exchange-rates--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-exchange-rates--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-exchange-rates--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-exchange-rates--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-exchange-rates--id-" data-method="DELETE"
      data-path="api/exchange-rates/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-exchange-rates--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-exchange-rates--id-"
                    onclick="tryItOut('DELETEapi-exchange-rates--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-exchange-rates--id-"
                    onclick="cancelTryOut('DELETEapi-exchange-rates--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-exchange-rates--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-exchange-rates--id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-exchange-rates--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-exchange-rates--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-exchange-rates--id-"
               value="16"
               data-component="url">
    <br>
<p>The ID of the exchange rate. Example: <code>16</code></p>
                ...
                <h1 id="profile">Profile</h1>
                                ...
                                <h2 id="profile-GETapi-me">GET api/me</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="profile-PATCHapi-me-preferences">PATCH api/me/preferences</h2>
...
<span id="example-requests-PATCHapi-me-preferences">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-me-preferences">
</span>
<span id="execution-results-PATCHapi-me-preferences" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-me-preferences"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-me-preferences"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-me-preferences" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-me-preferences">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-me-preferences" data-method="PATCH"
      data-path="api/me/preferences"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-me-preferences', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-me-preferences"
                    onclick="tryItOut('PATCHapi-me-preferences');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-me-preferences"
                    onclick="cancelTryOut('PATCHapi-me-preferences');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-me-preferences"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/me/preferences</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-me-preferences"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-me-preferences"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-me-preferences"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>reporting_currency_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="reporting_currency_id"                data-endpoint="PATCHapi-me-preferences"
               value="1"
               data-component="body">
    <br>
<p>The currency ID used for combined balances and reporting totals. The <code>id</code> of an existing record in the currencies table. Example: <code>1</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"type\": \"outgoing\",
    \"amount\": 250000,
    \"note\": \"Supermarket and household items\",
    \"occurred_on\": \"2026-05-10 18:45:00\"
}"
</code></pre></div>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The category that owns the transaction. Example: <code>3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="currency_id"                data-endpoint="POSTapi-transactions"
               value="2"
               data-component="body">
    <br>
<p>The native currency of the transaction amount. The <code>id</code> of an existing record in the currencies table. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Whether the record adds money or spends money. Example: <code>outgoing</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>incoming</code></li> <li><code>outgoing</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Positive native amount before conversion. Example: <code>250000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="POSTapi-transactions"
               value="Supermarket and household items"
               data-component="body">
    <br>
<p>Optional free-text note for the record. Example: <code>Supermarket and household items</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>occurred_on</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="occurred_on"                data-endpoint="POSTapi-transactions"
               value="2026-05-10 18:45:00"
               data-component="body">
    <br>
<p>When the transaction happened. Must be a valid date. Example: <code>2026-05-10 18:45:00</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"occurred_on\": \"2026-05-11 10:15:00\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated category ID. Example: <code>4</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>currency_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="currency_id"                data-endpoint="PUTapi-transactions--id-"
               value="1"
               data-component="body">
    <br>
<p>Updated native currency ID. The <code>id</code> of an existing record in the currencies table. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>type</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated transaction type. Example: <code>incoming</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>incoming</code></li> <li><code>outgoing</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated positive native amount. Example: <code>125.75</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>note</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="PUTapi-transactions--id-"
               value="Freelance payment received"
               data-component="body">
    <br>
<p>Updated optional note. Example: <code>Freelance payment received</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>occurred_on</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="occurred_on"                data-endpoint="PUTapi-transactions--id-"
               value="2026-05-11 10:15:00"
               data-component="body">
    <br>
<p>Updated transaction timestamp. Must be a valid date. Example: <code>2026-05-11 10:15:00</code></p>
        </div>
        </form>
